...
<!-- Siguiente caja de configuraciones -->
  ...
  <div class="col-lg-6">
    <div class="card mb-2">
      ...
      <div class="card-body">
        <form action="addstaff.php" method="POST" onsubmit="#">
          <div class="form-group"> 
            <label for="nombre_table">Nombre de empleado</label>
            <input type="text" name="nombre_empleado" id="nombre_empleado" class="form-control" placeholder="Ingrese empleado" required>
          </div>
          <div class="form-group">
              <label for="capacidad">Cargo</label>
              <select class="form-control form-control-mb" name="cargo_empleado" id="cargo_empleado" Required>
            ...
            <div class="form-group">
              <label for="capacidad">Contraseña</label>
              <input type="password" name="pwd_empleado" id="pwd_empleado" class="form-control" placeholder="Ingrese la contraseña"  required>
            </div>
          
          <div class="text-center">
            <input class="btn btn-success" type="submit" name="agregar_empleado" id="agregar_empleado" value="Agregar">
          </div>
        </form>
      </div>
    </div>
