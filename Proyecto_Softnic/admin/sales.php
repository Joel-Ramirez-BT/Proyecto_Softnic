    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
        <div class="card">
          <div class="row no-gutters">
            <div class="col-md-4">
            <i class="fa-solid fa-dollar-sign" style="color: #00f900;  font-size: 90px;"></i>
            </div>
            <div class="col-md-8">
              <div class="card-body">
                <p class="text-danger" >Hoy</p>
                <p class="card-text">C$ <?php echo getSalesGrandTotal("DAY"); ?></p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
        <div class="card">
          <div class="row no-gutters">
            <div class="col-md-4">
            <i class="fa-solid fa-hand-holding-dollar" style="color: #e32400; font-size: 80px;"></i>
            </div>
            <div class="col-md-8">
              <div class="card-body">
      ...
      <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
        <div class="card">
          <div class="row no-gutters">
            <div class="col-md-4">
            <i class="fa-solid fa-money-check-dollar" style="color: #74C0FC; font-size: 80px;"></i>
            </div>
            <div class="col-md-8">
              <div class="card-body">
                <p class="text-danger">Este mes</p>
                <p class="card-text">C$ <?php echo getSalesGrandTotal("MONTH"); ?></p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
        <div class="card">
          <div class="row no-gutters">
            <div class="col-md-4">
            <i class="fa-solid fa-sack-dollar" style="color: #ffaa00; font-size: 85px;"></i> 
                     </div>
            <div class="col-md-8">
              <div class="card-body">
              
                <p class="text-danger" >Todo el tiempo</p>
                <p class="card-text">C$ <?php echo getSalesGrandTotal("ALLTIME"); ?></p>
              </div>
            </div>
          </div>
        </div>
